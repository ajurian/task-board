...
export const PERMISSION_TASK_LIST_REORDER = 1 << 9;

export const PERMISSION_TASK_CREATE_DELETE = 1 << 10;
export const PERMISSION_TASK_UPDATE_TITLE = 1 << 11;
export const PERMISSION_TASK_UPDATE_DETAILS = 1 << 12;
export const PERMISSION_TASK_UPDATE_IS_DONE = 1 << 13;
export const PERMISSION_TASK_UPDATE_DUE_AT = 1 << 14;
export const PERMISSION_TASK_REORDER = 1 << 15;

export const PERMISSION_ROLE_OWNER = (1 << 16) - 1;
